    ...
    items: [
      {
        ...
        a: {
          nl: "De minor staat open voor 3e jaars HBO-studenten met een technische, design- of innovatiegerichte opleiding. Denk aan opleidingen als ICT, Technische Informatica, CMD, Business Innovation, Industrial Design, Technische Bedrijfskunde, Werktuigbouwkunde, Elektrotechniek, Mechatronica, Mens en Techniek, Bouwkunde of vergelijkbaar.",
          en: "The minor is open to 3rd year university of applied sciences students in technology, design, or innovation programs. Think of programs like ICT, Computer Science, Interaction Design, Business Innovation, Industrial Design, Industrial Engineering, Mechanical Engineering, Electrical Engineering, Mechatronics, People and Technology, Built Environment, or similar.",
        },
      },
      {
